...
@include('partials._breadcrumbs', ['pagina' => "Ofertas"])
	<!-- top-brands -->
	<div class="top-brands">
		<div class="container">
		<h2>Ofertas com preços imbatíveis</h2>
			<div class="grid_3 grid_5">

				
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">Em alta</a></li>
						<li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">Recentes</a></li>
					</ul>
													...
													<figure>
														<div class="snipcart-item block" >
															<div class="snipcart-thumb">
																<a href="products.html"><img class="img-responsive" title=" " alt=" " src="/images/produtos/{{$produto->imagem}}" /></a>
																...
																<h4>${{$produto->valor_unitario}} <span>{{$produto->valor_unitario + $produto->valor_unitario * 0.15}}</span></h4>
															</div>
															<div class="snipcart-details top_brand_home_details">
																<form action="#" method="post">
																	...
																	<fieldset>
																		...
																		<input type="hidden" name="item_name" value="{{$produto->nome_produto}}" />
																		<input type="hidden" name="amount" value="{{$produto->valor_unitario}}" />
																...
																@else
																	...
																	@if($produto->aceita_leilao)

																		<form action = "{{route('leilao')}}" class="form-inline" method="POST">
																			...
																			<div class="form-group">
																				<input name="lance" id="lance" type="text" class="form-control">
																				<button title="Submeter lance de leilão" type="submit"><i class="btn fa fa-gavel"></i></button>
																			</div>
																		</form>

																	@else

																		<p><b>Leilão indisponível<b></p>
														...
														<div class="snipcart-details top_brand_home_details">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="return" value=" " />
																	<input type="hidden" name="cancel_return" value=" " />
																	<input onClick = "alert(teste)" type="submit" name="submit" value="Add to cart" class="button" />
																</fieldset>
															</form>
														</div>
													</div>
