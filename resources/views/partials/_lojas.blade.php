  ...
  <div class="brands">
    ...
    <h3>Conheça nossas lojas!</h3>
      <div class="brands-agile">
        <div class="col-md-2 w3layouts-brand">
          <div class="brands-w3l" style="background-color: #fff; height: 232px">
            <p style="position:relative; top:25%"><a href="www.extra.com.br"><img style="height: 100%; width: 100%" src="images/extra_logo.png"></img></a></p>
          </div>
        </div>
        <div class="col-md-2 w3layouts-brand">
          <div class="brands-w3l" style="background-color: #fff; height: 232px">
          <p style="position: relative; top: 20%"><a href="www.magazineluiza.com.br"><img style="height: 100%; width: 100%; position: relative" src="images/magalu_logo.jpg"></img></a></p>
          </div>
        </div>
        <div class="col-md-2 w3layouts-brand">
          <div class="brands-w3l" style="background-color: #fff; height: 232px">
      ...
      <div class="brands-agile-1">
        <div class="col-md-2 w3layouts-brand">
          <div class="brands-w3l" style="background-color: #fff; height: 232px">
          <p style="position: relative; top: 20%"><a href="www.shoptime.com"><img style="height: 100%; width: 100%" src="images/shoptime_logo.png">Shoptime</img></a></p>
          </div>
        </div>
        <div class="col-md-2 w3layouts-brand">
          <div class="brands-w3l" style="background-color: #fff; height: 232px"> 
